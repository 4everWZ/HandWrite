...
class Windows(QtWidgets.QDialog, Ui_Form):
    ...
    def connect_signal(self):
        ...
        self.pushButton_reset.clicked.connect(self.set_default)
    ...
    def set_default(self):
        ...
        self.comboBox_background_color.setCurrentIndex(1)
    ...
    def preview(self):
        ...
        self.preview_image_dict = self.generator_engine.generate_image(self.get_text_from_textedit_main())
        self.img_show_func(self.preview_image_dict[0])
        self.page_number.addItems([str(i) for i in self.preview_image_dict])  # 设置page列表
    ...
    def export(self):
        self.preview()
        # 弹出提示框
        QMessageBox.information(self, "提示", "导出成功！请到outputs文件夹下查看")
