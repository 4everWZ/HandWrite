...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_preview = QtWidgets.QPushButton(Form)
        self.pushButton_preview.setObjectName("pushButton_preview")
        self.horizontalLayout_11.addWidget(self.pushButton_preview)
        self.pushButton_reset = QtWidgets.QPushButton(Form)
        self.pushButton_reset.setObjectName("pushButton_reset")
        self.horizontalLayout_11.addWidget(self.pushButton_reset)
